...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto" style="margin-right: 46px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../offers/index.php?id=<?php echo htmlspecialchars($_GET['id']); ?>"
                            style="color: #000000;">OFFERS</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="home_image"
        style="margin-left: 46px; margin-right: 46px; width: auto; text-align: center; position: relative;">
        <img src="../home/res/home-image.jpg" alt="Home Image" style="max-width: 100%;">
        <div class="image-text"
            style="position: absolute; top: 45%; left: 50%; transform: translate(-50%, -50%); width: 100%; text-align: center;">
        ...
        <div class="input-group mb-3"
            style="position: absolute; top: 65%; left: 50%; transform: translate(-50%, -50%); width: 80%;">
            <input type="text" class="form-control" placeholder="Insert your post code or address here"
                aria-label="Insert your post code or address here" aria-describedby="button-addon2">
    ...
    <div
        style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin-top: 40px; margin-left: 46px; margin-right: 46px;">
        <p style="font-family: 'Lato', sans-serif; font-weight: bold; font-size: 30px; color: #8692A6;">Temukan Ruang
            Acara Impian Anda</p>
        <div class="bg-kategori"
            style="display: flex; flex-direction: row; margin-top: 0; justify-content: space-between; align-items: center; padding-left: 40px; padding-right: 40px; max-width: 100%;">
            <select id="kategoriValue" class="form-select" aria-label="Default select example"
    ...
    <section class="daftar-hotel" style="margin-top: 60px; max-width: 100%;">
        <div style="display: flex; flex-direction: row; justify-content: space-between; max-width: 100%;">
            ...
            <div
                style="display: flex; flex-direction: column; width: 100%; align-items: center; margin-left: 65px; max-width: 100%;">
