...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <!-- Upload -->
            <form action="../../database/penyedia_gedung/addProduk.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id_penyedia_gedung" value="<?php echo htmlspecialchars($_GET['id']); ?>">
                <input type="hidden" id="hidden-title" name="judul">
                <input type="hidden" id="hidden-description" name="deskripsi">
                <input type="hidden" id="hidden-length" name="panjang">
                <input type="hidden" id="hidden-width" name="lebar">
                <input type="hidden" id="hidden-height" name="tinggi">
                <input type="hidden" id="hidden-price" name="harga">
                <input type="hidden" id="hidden-location" name="alamat">
                <input type="hidden" id="hidden-categories" name="kategori">
                <input type="hidden" id="hidden-capacity" name="kapasitas">
                <input type="hidden" id="hidden-av-equipment" name="AudiovisualEquipment">
                <input type="hidden" id="hidden-catering-service" name="cateringService">
                <input type="hidden" id="hidden-outdoor-space" name="outdoorSpace">
                <input type="hidden" id="hidden-decor" name="decoration">
                <input type="hidden" id="hidden-photography" name="Photography">
                <input type="hidden" id="hidden-others" name="others">
                <div class="upload-container">
                    ...
                    <div class="photo-grid">
                        <label class="upload-btn">
                            ...
                            <input type="file" accept="image/*" id="gambar" name="gambar" multiple>
                        </label>
                    </div>
                </div>
  ...
  <div style="justify-content: center; align-items: center; gap: 32px; display: flex">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var selectedCateringService = localStorage.getItem("selectedCateringService");
            var selectedOutdoorSpace = localStorage.getItem("selectedOutdoorSpace");
            var selectedDecor = localStorage.getItem("selectedDecor");
            var selectedPhotography = localStorage.getItem("selectedPhotography");
            var selectedOthers = localStorage.getItem("selectedOthers");
            var selectedCapacity = localStorage.getItem("selectedCapacity");
            var selectedAvEquipment = localStorage.getItem("selectedAvEquipment");
            ...
            console.log("Selected Catering Service: ", selectedCateringService);
            console.log("Selected Outdoor Space: ", selectedOutdoorSpace);
            console.log("Selected Decor: ", selectedDecor);
            console.log("Selected Photography: ", selectedPhotography);
            console.log("Selected Others: ", selectedOthers);
            console.log("Selected Capacity: ", selectedCapacity);
            console.log("Selected AV Equipment: ", selectedAvEquipment);

            // Set values to hidden inputs in the form
            ...
            document.getElementById("hidden-categories").value = selectedCategories ? selectedCategories.join(', ') : '';
            document.getElementById("hidden-capacity").value = selectedCapacity || '';
            document.getElementById("hidden-av-equipment").value = selectedAvEquipment || '';
            document.getElementById("hidden-catering-service").value = selectedCateringService || '';
            document.getElementById("hidden-outdoor-space").value = selectedOutdoorSpace || '';
            document.getElementById("hidden-decor").value = selectedDecor || '';
            document.getElementById("hidden-photography").value = selectedPhotography || '';
            document.getElementById("hidden-others").value = selectedOthers || '';
        });
    </script>
